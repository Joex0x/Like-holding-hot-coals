...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      $message[] = 'Product is existin your cart!';
   }else{
      mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, image, quantity) VALUES('$user_id','$product_name','$product_price','$product_image','$product_quantity')") or die('query failed');
      $message[] = 'Produs added';
   }
};
...
<div class="user-profile">
   ...
   <p>Currect user : <span><?php echo $fetch_user['name']; ?></span> </p>
   <div class="flex">
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Delete the product');">Delete</a></td>
         </tr>
      <?php
